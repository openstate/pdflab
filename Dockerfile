...
RUN pip install --no-cache-dir pdftotext==3.0.0 pymupdf==1.26.6 pymupdf-layout==1.26.6 pymupdf4llm==0.2.2 opencv-python tesserocr
...
RUN pip install --no-cache-dir pypdf==5.5.0
